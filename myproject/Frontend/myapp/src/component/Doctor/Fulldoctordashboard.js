...
const Fulldoctordashboard = () => {
    const [doctorData, setDoctorData] = useState(null); // Initialize doctorData as null
    const doctorcred = useSelector((state) =>state.check.value)
    console.log('Cred',doctorcred)
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("http://127.0.0.1:5000/Doctors/" +doctorcred.username);
                                    ...
                                    <MDBCol md="8">
                                        <MDBCardBody className="p-4">
                                            ...
                                            <MDBRow className="pt-1">
                                                ...
                                                <button type="button" className="btn btn-primary">View Appointment</button>
                                                </MDBCol>
                                            </MDBRow>
                                        </MDBCardBody>
                                    </MDBCol>
...
export default Fulldoctordashboard