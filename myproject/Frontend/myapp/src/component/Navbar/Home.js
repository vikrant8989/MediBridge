    ...
    <>
      <div className='maincardiv'>
        {/* <div className="card mycard">
          <img className="card-img-top" src="./Doctors/D3.jpg" alt="Card image cap" />
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./Medicines/Medicine1.jpg" alt="Card image cap2" />
          <div className="card-body">
      ...
      <div className='maincarddiv2'>
        <div className="card mycard">
          <img className="card-img-top" src="./problems/acne,pimple,skin.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./problems/back pain.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./problems/cough,cold,fever.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./problems/headache.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./problems/heartattack.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./problems/depression.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./problems/toothdecay.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./problems/kidney.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./problems/pregnancy_issue.png" alt="Card image cap2" />
          <div className="card-body">
      ...
      <div className='maincarddiv2'>
        <div className="card mycard">
          <img className="card-img-top" src="./Specialization/dental.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./Specialization/neurologist.png" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./Specialization/orthopedic.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./Specialization/dermatologist.png" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./Specialization/urologist.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./Specialization/Psychiatrist.jpg" alt="Card image cap2" />
          <div className="card-body">
        ...
        <div className="card mycard">
          <img className="card-img-top" src="./Specialization/cold.jpg" alt="Card image cap2" />
          <div className="card-body">
